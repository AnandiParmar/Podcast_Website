...
const Footer =() =>
{
   return(
    ...
    <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        <div className="me-5 d-none d-lg-block" id="social_links">
            ...
            <div className="row mt-3">
                ...
                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <p>
                        ...
                        doloribus, nemo corporis debitis, totam vero distinctio quidem temporibus esse ratione
                        recusandae iste explicabo, voluptatem harum? Ullam, fugiat fugit?
                    </p>
                </div>
